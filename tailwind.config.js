  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        float2: {
          '0%, 100%': { transform: 'translate(0px, 0px) rotate(0deg)' },
          '33%': { transform: 'translate(-10px, -12px) rotate(-1.2deg)' },
          '66%': { transform: 'translate(10px, -8px) rotate(1.2deg)' },
        },
        float3: {
          '0%, 100%': { transform: 'translate(0px, 0px) rotate(0deg)' },
          '33%': { transform: 'translate(15px, -12px) rotate(1.5deg)' },
          '66%': { transform: 'translate(-10px, -15px) rotate(-1.5deg)' },
        },
        float4: {
          '0%, 100%': { transform: 'translate(0px, 0px) rotate(0deg)' },
          '33%': { transform: 'translate(-12px, -14px) rotate(-1.3deg)' },
          '66%': { transform: 'translate(12px, -10px) rotate(1.3deg)' },
        },
        float5: {
          '0%, 100%': { transform: 'translate(0px, 0px) rotate(0deg)' },
          '33%': { transform: 'translate(10px, -15px) rotate(1.1deg)' },
          '66%': { transform: 'translate(-12px, -12px) rotate(-1.1deg)' },
        },
        float6: {
          '0%, 100%': { transform: 'translate(0px, 0px) rotate(0deg)' },
          '33%': { transform: 'translate(-15px, -10px) rotate(-1.4deg)' },
          '66%': { transform: 'translate(12px, -14px) rotate(1.4deg)' },
        },
        float7: {
          '0%, 100%': { transform: 'translate(0px, 0px) rotate(0deg)' },
          '33%': { transform: 'translate(12px, -12px) rotate(1.6deg)' },
          '66%': { transform: 'translate(-8px, -10px) rotate(-1.6deg)' },
        },
        float8: {
          '0%, 100%': { transform: 'translate(0px, 0px) rotate(0deg)' },
          '33%': { transform: 'translate(-10px, -12px) rotate(-1.2deg)' },
          '66%': { transform: 'translate(15px, -15px) rotate(1.2deg)' },
        },
      },
      backgroundImage: {
